...
var I18N = (function () {
  ...
  var EN = {
    ...
    "同期中（ログイン済み）": "Syncing (signed in)",
    "この端末に保存（ログインで同期）": "Saved on this device (sign in to sync)",
    "ログインすると、端末が変わっても記録が同期されます": "Sign in and your journal follows you across devices",
    "メールアドレス": "Email address",
    "ログインリンクを送る": "Send sign-in link",
    "ログアウト": "Sign out",
    "確認メールを送りました。メール内のリンクを開くと、この端末でログインされます。": "Check your inbox — opening the link signs you in on this device.",
    "送信に失敗しました：{msg}": "Could not send: {msg}",
    "以前の記録を引き取る": "Claim your earlier entries",
    "あなたの記録者名を選ぶと、その記録がこのアカウントに紐づきます。": "Pick the name you used to record under, and those entries will be attached to this account.",
    "自分の記録はありません": "None of these are mine",
    "{n}件の記録を引き取りました": "Claimed {n} entries",
    "引き取りに失敗しました：{msg}": "Could not claim: {msg}",
    ...
    /* ---------- はじめの一本さがし ---------- */
    "はじめの一本さがし": "Find your first cigar",
    "葉巻を吸ったことはありますか？": "Have you smoked a cigar before?",
    "はじめて": "Never",
    "これから一本目": "My first one is still ahead",
    "何本か": "A few",
    "まだ探している途中": "Still working out what I like",
    "慣れている": "Often",
    "好みが分かってきた": "I know roughly what suits me",
    "どのくらいの時間がとれますか？": "How much time do you have?",
    "30分ほど": "About 30 minutes",
    "短めに一服": "A short sit-down",
    "1時間くらい": "An hour or so",
    "ゆっくりめ": "Unhurried",
    "たっぷり": "As long as it takes",
    "時間を気にせず": "No need to watch the clock",
    "味わいの好みは？": "What sort of body do you like?",
    "軽やかに": "Light",
    "穏やかで香りを楽しむ": "Gentle, for the aroma",
    "ほどよく": "Medium",
    "軽すぎず重すぎず": "Neither thin nor heavy",
    "しっかり": "Full",
    "濃く力強い": "Rich and powerful",
    "産地に希望はありますか？": "Any preference on origin?",
    "キューバ": "Cuba",
    "本場を試したい": "I want the real Havana",
    "新世界": "The New World",
    "中米・カリブの新しい作り手": "Newer makers in Central America and the Caribbean",
    "こだわらない": "No preference",
    "おいしければどこでも": "Anywhere, as long as it is good",
    "ひとつ戻る": "Back one",
    "{a} / {b}": "{a} of {b}",
    "あなたに合いそうな3本": "Three that should suit you",
    "好みの強さに合う": "matches the body you like",
    "好みよりやや穏やか": "a shade gentler than you asked for",
    "好みよりやや力強い": "a shade fuller than you asked for",
    "本場キューバ": "a true Havana",
    "入手しやすい定番": "easy to find",
    "・": " · ",
    "くわしく見る": "Read more",
    "太さはこのあたりを": "Try it in this size",
    "強さ・産地・定番かどうかから選んでいます。値段は銘柄ごとの資料が無いため、選定には入れていません。":
      "Chosen on body, origin and how easy the marque is to find. Price is not part of it — we do not hold price data for individual marques.",
    "もう一度えらぶ": "Start again",
    "価格帯から探す": "Browse by price",
    "データを読み込めませんでした。ページを開き直してみてください。": "Could not load the data. Try opening the page again.",
    "マイルド": "Mild",
    "ライト": "Light",
    "ミディアム": "Medium",
    "ミディアムフル": "Medium-Full",
