    ...
    },
    {
      ...
      "prefectures": [
        ...
        },
        {
          ...
          "pref_en": "Osaka",
          "region": "近畿",
          "prefNote": "大阪は東京に次ぐシガー激戦区。北新地・梅田・淀屋橋・心斎橋にシガーバーとハバノス取扱店が集中し（スーペルノーバ、エドモンダンテス、洋煙、シガークラブ等）、豊中・高槻など郊外には葉巻を扱う大型たばこ専門店（シリウスタバコ、阪口商店）がある。ホテルバー（リッツ・カールトン大阪 等）でも葉巻を楽しめる。バー併設・商業施設内テナントは時期により営業状況が変わるため、来店前の確認を推奨。",
          "shops": [
            {
            ...
            },
            {
              ...
              "type": "ホテルラウンジ",
              "area": "大阪市北区・梅田／北新地",
              "desc": "ザ・リッツ・カールトン大阪のメインバー。モルトウイスキーやマティーニなど計460種類の酒に加え、16種類のシガーを揃える。ジャズの生演奏が流れる重厚な空間で葉巻を楽しめる。",
              "note": "専門店ではなくホテルバーでのシガー提供。銘柄・在庫は時期により変動。",
              "status": "営業",
              "sources": [
